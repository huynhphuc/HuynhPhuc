...
public class Message implements Serializable {
	...
	public String conver(String str1)
	{
		str1 = str1.replace("<", "&lt;");
		str1 = str1.replace(">", "&gt;");
		return str1;
	...
	public String toString() {
		...
		if (this.type.equals("login") && this.content.equals("FALSE")
			...
			return "<SESSION>"   + "<PEER_NAME>" + sender + "</PEER_NAME>"
					 + "<PORT>" + content + "</PORT>" + 
					 "</SESSION>";
			...
			return "<SESSION>"   + "<PEER_NAME>" + sender + "</PEER_NAME>"
					 + "<PORT>" + content + "</PORT>" + 
					 "</SESSION>";
		else if (this.type.equals("signout") && this.recipient.equals("SERVER"))
			return "<SESSION_KEEP_ALIVE>" +   "<PEER_NAME>" + sender
					+ "</PEER_NAME>"   + "<STATUS>" + conver("OOPS >>>WILL BE KILLED<<< ") + "</STATUS>"
					  + "</SESSION_KEEP_ALIVE>";
		else if (this.type.equals("alive") && this.recipient.equals("SERVER"))
			return "<SESSION_KEEP_ALIVE>" +   "<PEER_NAME>" + sender
			...
			return "<CHAT_MSG>" + conver(this.content) + "</CHAT_MSG>"  ;
